...
def seed_data():
    ...
    try:
        ...
        courses_data = [
            ('Matemáticas Avanzadas', 'Cálculo diferencial e integral', 'MATH301', users['teacher1']),
            ('Programación Web', 'Desarrollo de aplicaciones web modernas', 'CS201', users['teacher1']),
            ('Base de Datos', 'Diseño e implementación de bases de datos', 'CS301', users['teacher2']),
            ('Física General', 'Mecánica clásica y termodinámica', 'PHYS101', users['teacher2'])
        ]
        ...
        print(f"  ✅ {len(courses_data)} cursos insertados")
        ...
        print(f"  ✅ {len(assignments_data)} asignaciones insertadas")
        ...
        print(f"  ✅ {len(enrollments_data)} inscripciones insertadas")
        ...
        print(f"  • {len(assignments_data)} asignaciones")
        print(f"  • {len(enrollments_data)} inscripciones")
